...
//
// Detailed usage document and tutorial available on the go-saman Wiki page:
// https://github.com/saman-org/go-saman/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
