...
import (
	...
	"github.com/saman-org/go-saman/consensus/misc"
	...
	"github.com/saman-org/go-saman/crypto/sha3"
...
var (
	samanBlockReward = big.NewInt(0.3375e+18) // Block reward in wei to masternode account when successfully mining a block
