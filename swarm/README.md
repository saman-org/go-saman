...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/saman-org/go-saman

    go install github.com/saman-org/go-saman/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/saman-org/go-saman`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/saman-org/go-saman
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/saman-org/go-saman/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/saman-org/go-saman/wiki/Code-Review-Guidelines).
