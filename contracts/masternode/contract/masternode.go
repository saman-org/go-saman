...
import (
	...
	ethereum "github.com/saman-org/go-saman"
	"github.com/saman-org/go-saman/accounts/abi"
...
// SamanMin is a free data retrieval call binding the contract method 0xc808021c.
//
// Solidity: function samanMin() constant returns(uint256)
func (_Contract *ContractCaller) SamanMin(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "samanMin")
	return *ret0, err
}
...
//
// Solidity: function samanMin() constant returns(uint256)
func (_Contract *ContractSession) SamanMin() (*big.Int, error) {
	return _Contract.Contract.SamanMin(&_Contract.CallOpts)
}

// SamanMin is a free data retrieval call binding the contract method 0xc808021c.
//
// Solidity: function samanMin() constant returns(uint256)
func (_Contract *ContractCallerSession) SamanMin() (*big.Int, error) {
	return _Contract.Contract.SamanMin(&_Contract.CallOpts)
}

// SamanPerNode is a free data retrieval call binding the contract method 0xff5ecad2.
//
// Solidity: function samanPerNode() constant returns(uint256)
func (_Contract *ContractCaller) SamanPerNode(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "samanPerNode")
	return *ret0, err
}
...
//
// Solidity: function samanPerNode() constant returns(uint256)
func (_Contract *ContractSession) SamanPerNode() (*big.Int, error) {
	return _Contract.Contract.SamanPerNode(&_Contract.CallOpts)
}

// SamanPerNode is a free data retrieval call binding the contract method 0xff5ecad2.
//
// Solidity: function samanPerNode() constant returns(uint256)
func (_Contract *ContractCallerSession) SamanPerNode() (*big.Int, error) {
	return _Contract.Contract.SamanPerNode(&_Contract.CallOpts)
}
