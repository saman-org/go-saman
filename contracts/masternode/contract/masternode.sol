...
contract Masternode {
    ...
    uint public constant samanPerNode = 20000 * 10 ** 18;
    uint public constant samanMin = 10 ** 16;
    ...
    function() payable public {
        ...
        if (id != bytes8(0) && has(id)){
            ...
            require(
                ...
                bytes8(0) != id &&
                bytes32(0) != id1 &&
                address(this).balance >= (samanPerNode - samanMin) &&
                count > 0
            );
            ...
            if(notGenesisNode){
                msg.sender.transfer(samanPerNode - samanMin);
            }
        }
