...
type ChainConfig struct {
	...
	SamanBlock *big.Int `json:"SamanBlock,omitempty"` // Saman switch block (nil = no fork, 0 = already on Saman)
...
// IsSaman returns whether num is either equal to the Saman masternode fork block or greater.
func (c *ChainConfig) IsSaman(num *big.Int) bool {
	return isForked(c.SamanBlock, num)
}
