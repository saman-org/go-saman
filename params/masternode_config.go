...
type MasternodeChainConfig struct {
	...
	TestnetContractEndpoint   string        // TestnetContractEndpoint to fetch the contract address of the Saman testnet.
...
var defaultMasternodeConfig = &MasternodeChainConfig{
	...
	// Saman Masternode sharding constants.
	...
	// Testnet misc values.
	TestnetContractEndpoint: "https://www.saman.org/contract", // defines an http endpoint to fetch the testnet contract addr.
}
